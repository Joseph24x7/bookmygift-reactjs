  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      <h1 className="text-4xl font-bold text-gray-600 my-10">
        Welcome, {userDetails ? userDetails.name : "User"}!
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-3xl">
        <div
          className="dashboard-item p-8 bg-white rounded-lg shadow-md border border-gray-300 cursor-pointer transform transition-transform hover:scale-105 hover:shadow-lg"
